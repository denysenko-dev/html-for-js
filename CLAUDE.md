...
`lesson-16` is one snapshot in a per-lesson branch chain (`lesson-1` … `lesson-19`) built for a frontend
...
where this same project sits under `main`'s `unit_16/` instead of the repo root. Don't expect `unit_NN/`
